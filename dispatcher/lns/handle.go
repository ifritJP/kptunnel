...
// for 139: ExpCast
func conv2Form0_747( src func (_env *LnsEnv)) LnsForm {
    return func (_env *LnsEnv,  argList []LnsAny) []LnsAny {
        src(_env)
        return []LnsAny{}
    }
...
// for 137
func handle_convExp0_780(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 183
func handle_convExp0_983(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 204
func handle_convExp0_1048(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 223
func handle_convExp0_1100(arg1 []LnsAny) (LnsAny, string) {
...
// for 115
func handle_convExp0_632(arg1 []LnsAny) LnsAny {
    return Lns_getFromMulti( arg1, 0 )
}
// for 135
func handle_convExp0_723(arg1 []LnsAny) (LnsAny, LnsAny) {
    return Lns_getFromMulti( arg1, 0 ), Lns_getFromMulti( arg1, 1 )
}
// 114: decl @lns.@handle.convScript
func handle_convScript_3_(_env *LnsEnv, path string) LnsAny {
    var fileObj Lns_luaStream
    
    {
        _fileObj := handle_convExp0_632(Lns_2DDD(Lns_io_open(path, nil)))
        if _fileObj == nil{
...
// 132: decl @lns.@handle.loadScript
func handle_loadScript_4_(_env *LnsEnv, luaCode string,path string,funcName string) LnsAny {
    ...
    _func = nil
        ...
        if loaded != nil{
            ...
            {
                _mod := handle_convExp0_780(Lns_2DDD(_env.GetVM().RunLoadedfunc(loaded_128,Lns_2DDD([]LnsAny{}))))
                if !Lns_IsNil( _mod ) {
                    mod := _mod
                    {
...
// 153: decl @lns.@handle.setupHandle
func Handle_setupHandle(_env *LnsEnv, path string) bool {
    ...
    var result bool
    result = false
    Lns_LockEnvSync( _env, 181, func () {
        {
            __func := handle_loadScript_4_(_env, luaCode, handlePath, "createHandler")
            if !Lns_IsNil( __func ) {
                _func := __func.(*Lns_luaValue)
                {
                    _obj := handle_convExp0_983(Lns_2DDD(_env.GetVM().RunLoadedfunc(_func,Lns_2DDD([]LnsAny{}))))
                    if !Lns_IsNil( _obj ) {
                        obj := _obj
    ...
    if handle_canAcceptLuaCode != ""{
            {
                ...
                if !Lns_IsNil( __func ) {
                    _func := __func.(*Lns_luaValue)
                    {
                        _obj := handle_convExp0_1048(Lns_2DDD(_env.GetVM().RunLoadedfunc(_func,Lns_2DDD([]LnsAny{}))))
                        if !Lns_IsNil( _obj ) {
                            obj := _obj
...
// 218: decl @lns.@handle.getTunnelInfo
...
// 229: decl @lns.@handle.onEndTunnel
...
func (self *handle_DefaultHandler) GetTunnelInfo(_env *LnsEnv, uri string,headerMap *LnsMap)(LnsAny, string) {
    ...
    var mode string
    mode = "wsclient"
    return NewTypes_ReqTunnelInfo(_env, "localhost", self.port, connectMode, mode, NewLnsList([]LnsAny{"../kptunnel", mode, ":10000", "-omit"}), NewLnsMap( map[LnsAny]LnsAny{"GOGC":"50",})), ""
}
// 106: decl @lns.@handle.DefaultHandler.onEndTunnel
